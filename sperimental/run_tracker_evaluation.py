...
from sperm_src.parse_arguments import parse_arguments
from sperm_src.region_to_bbox import region_to_bbox
    ...
    if evaluation.video == 'all':
        ...
        for i in range(nv):
            ...
            for j in range(evaluation.n_subseq):
                ...
                b_boxes, speed[idx] = tracker(frame_name_list_, pos_x, pos_y,
        ...
        b_boxes, speed = tracker(frame_name_list, pos_x, pos_y, target_w, target_h, final_score_sz, filename, image, templates_z, scores)
